...
class WebsiteReportGroup(RuleGroupResult):
	...
	num_user_pages   = models.IntegerField(default=0)
	num_user_reports = models.IntegerField(default=0)

	num_anonymous_pages   = models.IntegerField(default=0)
	num_anonymous_reports = models.IntegerField(default=0)

	ws_reports = models.ManyToMany(WebsiteReport)

  	class Meta:
    	verbose_name        = "Website Reoprt Group"
