...
class WebsiteRuleCategoryResultAdmin(admin.ModelAdmin):
    list_display = ('rule_category', 'slug', 'ws_report', 'rules_violation', 'rules_warning', 'rules_manual_check', 'rules_passed', 'implementation_score', 'implementation_status')
...
class WebsiteGuidelineResultAdmin(admin.ModelAdmin):
    list_display = ('guideline', 'slug', 'ws_report', 'rules_violation', 'rules_warning', 'rules_manual_check', 'rules_passed', 'implementation_score', 'implementation_status')
...
class WebsiteRuleScopeResultAdmin(admin.ModelAdmin):
    list_display = ('rule_scope', 'slug', 'ws_report', 'rules_violation', 'rules_warning', 'rules_manual_check', 'rules_passed', 'implementation_score', 'implementation_status')
...
class WebsiteRuleResultAdmin(admin.ModelAdmin):
    list_display = ('rule', 'ws_report', 'slug', 'pages_violation', 'pages_warning', 'pages_manual_check', 'pages_passed', 'pages_na', 'implementation_score', 'implementation_status')
