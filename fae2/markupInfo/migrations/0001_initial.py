    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frame_count', models.IntegerField(default=0)),
                ('iframe_count', models.IntegerField(default=0)),
                ('ws_report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mi_ws_report', to='reports.WebsiteReport')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ws_markup_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='page_ws_markup_items', to='markupInfo.WebsiteMarkupItem')),
            ],
        ),
        migrations.AddField(
