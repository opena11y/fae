    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_pages', models.IntegerField(choices=[(0, b' All pages'), (5, b'   5 pages'), (10, b'  10 pages'), (25, b'  25 pages')], default=0, verbose_name=b'Maximum Pages')),
                ...
                ('last_view', models.CharField(default=b'rc', max_length=4, verbose_name=b'Last View')),
                ('last_page', models.IntegerField(default=1, verbose_name=b'Last Page Viewed')),
                ('last_next_page', models.IntegerField(default=0, verbose_name=b'Next Page Number')),
                ('last_prev_page', models.IntegerField(default=0, verbose_name=b'Previous Page Number')),
                ('last_first_page', models.IntegerField(default=0, verbose_name=b'First Page Number')),
                ('last_last_page', models.IntegerField(default=0, verbose_name=b'Last Page Number')),
                ('next_page_url', models.URLField(blank=True, default=b'', max_length=1024, verbose_name=b'Next Page URL')),
                ('prev_page_url', models.URLField(blank=True, default=b'', max_length=1024, verbose_name=b'Previous Page URL')),
                ('first_page_url', models.URLField(blank=True, default=b'', max_length=1024, verbose_name=b'First Page URL')),
                ('last_page_url', models.URLField(blank=True, default=b'', max_length=1024, verbose_name=b'Last Page URL')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(choices=[(b'-', b'Created'), (b'I', b'Initalized'), (b'A', b'Analyzing'), (b'S', b'Saving'), (b'C', b'Complete'), (b'E', b'Error'), (b'SUM', b'Summary')], default=b'-', max_length=10, verbose_name=b'Status')),
