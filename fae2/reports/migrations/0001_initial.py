    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depth', models.IntegerField(choices=[(1, b'Top-level page only'), (2, b'Include second-level pages'), (3, b'Include third-level pages'), (4, b'Include fourth-level pages'), (5, b'Include fifth-level pages'), (8, b'Include maximum-level (8 levels) pages')], default=2, verbose_name=b'Depth of Evaluation')),
                ('max_pages', models.IntegerField(choices=[(5, b'   5 pages'), (10, b'  10 pages'), (25, b'  25 pages'), (50, b'  50 pages'), (100, b' 100 pages'), (200, b' 200 pages'), (400, b' 400 pages'), (800, b' 800 pages'), (1600, b'1600 pages')], default=0, verbose_name=b'Maximum Pages')),
