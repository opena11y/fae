    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rules', to='ruleCategories.RuleCategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_editor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='rule',
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rules', to='rules.RuleGroup'),
        ),
        migrations.AddField(
            model_name='rule',
            name='scope',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rules', to='rules.RuleScope'),
        ),
        migrations.AddField(
            model_name='rule',
        ...
        migrations.AddField(
            model_name='rule',
            name='wcag_primary',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rules', to='wcag20.SuccessCriterion'),
        ),
        migrations.AddField(
            model_name='rule',
            name='wcag_related',
