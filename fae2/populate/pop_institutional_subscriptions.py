...
def create_institutional_profile(type_id, domain, alt_domain, name1, email1, phone1, name2, email2, phone2, start, end):
  ...
  try:
    ...
    ip = InstitutionalProfile(account_type=atype,top_level_domain='edu',domain=domain,alt_domain=alt_domain,contact1_name=name1,contact1_email=email1,contact1_phone=phone1,contact2_name=name2,contact2_email=email2,contact2_phone=phone2,subscription_start=start,subscription_end=end)
